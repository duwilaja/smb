...
$cols="nrp,tgl,kasus,jalan,callin,finished,if(finished>callin,timediff(finished,callin),timediff(finished,subtime(callin,'24:00:00'))) as dur";
$tname="intan_analytic";
?>

<div class="card">
	<div class="card-header">
		<div class="card-title judul">INTAN Analytic
